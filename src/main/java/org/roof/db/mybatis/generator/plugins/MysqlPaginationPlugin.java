...
public class MysqlPaginationPlugin extends PluginAdapter {
    ...
    public boolean modelExampleClassGenerated(TopLevelClass topLevelClass,
        ...
        addLimit(topLevelClass, introspectedTable, "firstrownum");
    ...
    private void createLimit(XmlElement element) {
        XmlElement isNotNullElement = new XmlElement("if");
        isNotNullElement.addAttribute(new Attribute("test",
                "firstrownum != null and limit >= 0"));
    ...
    private void addLimit(TopLevelClass topLevelClass,
        ...
        /**
         * 创建类成员变量 如protected Long limitStart;
         */
